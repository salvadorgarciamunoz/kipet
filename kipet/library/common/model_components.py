    ...
    def add_component(self, *args, **kwargs):
        ...
        if len(args) == 1:
            if isinstance(args[0], ModelComponent):
                ...
                self._add_component_with_terms(args[0], state, init, variance)
...
class ModelComponent():
    ...
    def __init__(self, name=None, state=None, init=None, variance=None):
    ...
    def __str__(self):
        return f'Component: {self.name}, {self.state}, init={self.init}, variance={self.variance}'
