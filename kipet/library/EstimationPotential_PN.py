...
class EstimationPotential(ParameterEstimator):
    ...
    def _calculate_reduced_hessian(self, Se, Sf, verbose=False):
        ...
        # Here is where you need to implement the new contraints
...
#        self.rh_model.ipopt_zU_in.update(self.rh_model.ipopt_zU_out)
        ...
        #self.rh_model.P.display()
        #self.rh_model.K.display()
        #self.rh_model.d.display()
        #self.rh_model.fix_params_to_global.display()
        ...
        kkt_df, hess, jac, var_ind, con_ind_new = self._JH(self.rh_model)
        # print(con_ind_new)
        # print(jac.shape)
        # print(jac.columns)
        # print(jac.index)
