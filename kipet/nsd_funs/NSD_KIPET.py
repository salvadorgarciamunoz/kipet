...
class NSD():
    ...
    def run_opt(self):
        ...
        if self.strategy == 'ipopt':
            ...
            self.run_simple_newton_step(alpha=0.1, iterations=15)  
    ...
    def plot_results(self):
        ...
        if self.isKipetModel:
            ...
            for name, model in self.reaction_models.items():
                ...
                model.results.plot(description=description, extra_data={'data': model.datasets['C_data'].data, 'label': 'Meas.', 'mode': 'marker'})        
