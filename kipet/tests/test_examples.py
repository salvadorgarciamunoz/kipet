...
class TestExamples(unittest.TestCase):
    ...
    def _schedule(self, examples_dir):
        ...
        examples_plainpyomo = [f for f in os.listdir(examples_dir) if
                               os.path.isfile(os.path.join(examples_plainpyomo_dir, f)) and f.endswith('.py')]
        ...
        if os.path.isdir(os.path.join(examples_dir, 'pyomo')) == True:
            ...
            examples_pyomo = [f for f in os.listdir(examples_pyomo_dir) if
                              os.path.isfile(os.path.join(examples_pyomo_dir, f)) and f.endswith('.py')]
            ...
            if found_casadi:
                ...
                examples_casadi = [f for f in os.listdir(examples_casadi_dir) if
                                   os.path.isfile(os.path.join(examples_casadi_dir, f)) and f.endswith('.py')]
                countc = 0
                flagc = 0
