...
if __name__ == "__main__":
   ...
   # components
    ...
    write_absorption_data_to_csv(
        os.path.join(dataDirectory, 'multexp2S.csv'), S_Dataframe)
    write_spectral_data_to_csv(os.path.join(dataDirectory, 'multexp2D.csv'), D_Dataframe)
    write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp2C.csv'), C_Dataframe)
    write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp2Z.csv'), Z_Dataframe)
    write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp2dZdT'), dZ_Dataframe)
