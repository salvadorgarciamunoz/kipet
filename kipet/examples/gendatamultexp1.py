...
def Lorentzian_parameters():
    ...
    params_e = dict()
    params_e['alphas'] = [0.4, 0.2, 1.0, 0.4]
    params_e['betas'] = [150.0, 170.0, 205.0, 250.0]
    params_e['gammas'] = [100.0, 30000.0, 100.0, 100.0]
    ...
    return {'A': params_d,'B':params_a,'C': params_c, 'D': params_b, 'E': params_e}
...
if __name__ == "__main__":
   ...
   # components
    ...
    write_absorption_data_to_csv(
        os.path.join(dataDirectory, 'multexp1S.csv'), S_Dataframe)
    write_spectral_data_to_csv(os.path.join(dataDirectory, 'multexp1D.csv'), D_Dataframe)
    write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp1C.csv'), C_Dataframe)
    write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp1Z.csv'), Z_Dataframe)
    write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp1dZdT'), dZ_Dataframe)
