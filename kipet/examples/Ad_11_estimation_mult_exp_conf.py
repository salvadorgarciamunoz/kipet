...
if __name__ == "__main__":
    ...
    D_frame1 = read_spectral_data_from_csv(filename1)
    D_frame2 = read_spectral_data_from_csv(filename2)
    ...
    D_frame1 = decrease_wavelengths(D_frame1,A_set = 4)
    ...
    D_frame2 = decrease_wavelengths(D_frame2,A_set = 4)
    ...
    builder2.add_parameter('k1', init=2, bounds=(0.00,10)) 
    #There is also the option of providing initial values: Just add init=... as additional argument as above.
    builder2.add_parameter('k2',init = 0.2, bounds=(0.0,1))
    builder2.add_parameter('k3',init =  0.02, bounds=(0.0,1))
    ...
    sigmas2 = {'A':1e-10,'B':1e-10,'C':1e-10, 'D':1e-10,'device':1e-6}
    variances = {'Exp1':sigmas, 'Exp2':sigmas2}
                 #, 'Exp3':sigmas}
