...
if __name__ == "__main__":
   ...
   # components
    ...
    #write_absorption_data_to_csv(os.path.join(dataDirectory, 'multexp5S.csv'), S_Dataframe)
    write_spectral_data_to_csv(os.path.join(dataDirectory, 'multexp5D.csv'), D_Dataframe)
    #write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp5C.csv'), C_Dataframe)
    #write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp5Z.csv'), Z_Dataframe)
    #write_concentration_data_to_csv(os.path.join(dataDirectory, 'multexp5dZdT'), dZ_Dataframe)
