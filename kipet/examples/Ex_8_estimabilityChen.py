...
if __name__ == "__main__":
    ...
    builder.add_parameter('k1',bounds=(0.1,2),init = 0.5)
    builder.add_parameter('k2',bounds=(0.0,2),init = 1)
    builder.add_parameter('k3',bounds=(0.0,2),init = 1.6)
    builder.add_parameter('k4',bounds=(0.0,2),init = 0.2)
    ...
    blam = e_analyzer.obtain_estimable_params(epsilon1 = 1e-25, epsilon2 = 1e-20,eta = 0.9, sigmas = sigmas)
