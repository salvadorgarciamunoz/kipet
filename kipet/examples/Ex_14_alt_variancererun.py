...
if __name__ == "__main__":
   ...
   # sigmas = sigmas
    ...
    # display results
    if with_plots:
        results_pyomo.C['A'].plot.line(legend=True)
        results_pyomo.C['B'].plot.line(legend=True, linestyle="--")
        results_pyomo.C['C'].plot.line(legend=True, linestyle="-.")
        results_pyomo.C['D'].plot.line(legend=True, linestyle=":")
        results_pyomo.C['E'].plot.line(legend=True, linestyle="-")
        results_pyomo.C['F'].plot.line(legend=True, linestyle="--")
        plt.xlabel("time (s)")
        plt.ylabel("Concentration (mol/L)")
        plt.title("Concentration Profile")
        plt.show()

        results_pyomo.S['A'].plot.line(legend=True)
        results_pyomo.S['B'].plot.line(legend=True, linestyle="--")
        results_pyomo.S['C'].plot.line(legend=True, linestyle="-.")
        results_pyomo.S['D'].plot.line(legend=True, linestyle=":")
        results_pyomo.S['E'].plot.line(legend=True, linestyle="-")
        results_pyomo.S['F'].plot.line(legend=True, linestyle="--")
