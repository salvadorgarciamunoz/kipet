...
if __name__ == "__main__":
    ...
    filename1 =  os.path.join(dataDirectory,'multexpEx31.csv')
    ...
    builder.add_parameter('k2',init =20, bounds=(5,30))
    builder.add_parameter('k3', init=0.3, bounds=(0.01,2)) 
    builder1.add_parameter('k1', init=1.5, bounds=(0.3,5)) 
    #There is also the option of providing initial values: Just add init=... as additional argument as above.
    builder1.add_parameter('k2',init =20, bounds=(4,30))
    builder1.add_parameter('k3', init=0.3, bounds=(0.01,2)) 
    builder2.add_parameter('k1', init=1.5, bounds=(0.3,5)) 
    #There is also the option of providing initial values: Just add init=... as additional argument as above.
    builder2.add_parameter('k2',init =20, bounds=(5,30))
    builder2.add_parameter('k3', init=0.3, bounds=(0.01,2)) 
    builder3.add_parameter('k1', init=1.5, bounds=(0.3,5)) 
    #There is also the option of providing initial values: Just add init=... as additional argument as above.
    builder3.add_parameter('k2',init =20, bounds=(5,30))
    builder3.add_parameter('k3', init=0.3, bounds=(0.01,2)) 
    ...
    components1 = {'A':3e-2,'B':4e-2,'C':0, 'D':2e-2,'E':0,'F':0}
    ...
    #builder3.bound_profile(var = 'S', comp = 'E', profile_range=(180,195), bounds = (0.0,0.1))
    #builder3.bound_profile(var = 'S', comp = 'C', profile_range=(180,210), bounds = (0.0,0.1))
    #builder3.bound_profile(var = 'S', comp = 'D', profile_range=(180,200), bounds = (0.0,0.1))
    #builder3.bound_profile(var = 'S', comp = 'A', profile_range=(189,200), bounds = (0.0,0.1))
    #builder3.bound_profile(var = 'S', comp = 'A', profile_range=(188,190), bounds = (0.0,0.6))
    #builder3.bound_profile(var = 'S', comp = 'A', profile_range=(191,198), bounds = (0.0,0.05))
    #builder3.bound_profile(var = 'S', comp = 'F', profile_range=(187,192), bounds = (0.0,0.05))
    ...
    #variances = {'Exp1':sigmas, 'Exp2':sigmas}
                                    #1e-08 6e-08
    initsigs = {'Exp1': 9e-08, 'Exp2': 1.5e-08,'Exp3': 1e-08, 'Exp4': 1e-08}
    secantpoint = {'Exp1': 7e-08,'Exp2':5e-08,'Exp3': 6e-08,'Exp4':6e-08}
    tolerance = {'Exp1': 1e-8, 'Exp2': 1e-9,'Exp3': 1e-9, 'Exp4': 1e-9}
