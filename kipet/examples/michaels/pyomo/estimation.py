...
if __name__ == "__main__":
    ...
    opt.initialize_from_trajectory('Z',initialization.Z)
    opt.initialize_from_trajectory('Y',initialization.Y)
    ...
    raw_results = opt.run_lsq_given_P('ipopt',p_guess,tee=True)
