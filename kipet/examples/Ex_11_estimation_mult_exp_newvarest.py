...
if __name__ == "__main__":
    ...
    Exp1sigmas ={'A':1e-10,'B':1e-10,'C':1e-11,'device':1e-6}
    Exp2sigmas = {'A':1e-10,'B':1e-10,'C':1e-11,'device':1e-6}
    Exp3sigmas = {'A':1e-10,'B':1e-10,'C':1e-11,'device':1e-6}
    initsigs = {'Exp1': 1e-10, 'Exp2': 1e-10}
    secantpoint = {'Exp1': 1e-11,'Exp2':1e-11}
    tolerance = {'Exp1': 1e-10, 'Exp2': 1e-10}
