...
if __name__ == "__main__":
    ...
    def rule_odes(m,t):
        exprs = dict()
        exprs['A'] = -m.P['k1']*m.Z[t,'A']
        exprs['B'] = m.P['k1']*m.Z[t,'A']-m.P['k2']*m.Z[t,'B']-m.P['k3']*m.Z[t,'B']**4
        exprs['C'] = m.P['k2']*m.Z[t,'B']
        exprs['D'] = m.P['k3']*m.Z[t,'B']**4
        return exprs
    ...
    # Notice here that we have a lot of potential solver options for the linear system.
    # This is where we make or break the IPOPT solve nd so it is important to tweak these options
